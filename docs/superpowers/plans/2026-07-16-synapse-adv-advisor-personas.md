...
- [ ] **Step 1: Write the failing-or-green guard test**
...
- [ ] **Step 4: Implement — turn_context.py**
...
- [ ] **Step 4: Extend the exact-set assert (documented frozen-test exception)**
...
- [ ] **Step 1: Full suite + count reconciliation**
...
- [ ] **Step 4: Конфаб-прогон (РУЧНОЙ DoD-гейт §7 — Теро/живая LLM, НЕ автоматизируется)**
